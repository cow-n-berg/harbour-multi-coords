...
Dialog {
    ...
    onAccepted: {
        ...
        for (var i = 0; i < numberItems; ++i) {
            var wpnr = listModel.get(i).number + (offsetValue.value);
...
//            SectionHeader {
//                text: qsTr("RegEx for Formula search in raw text")
//            }
...
//            }
            ...
            TextArea {
                id: description2
                width: parent.width
                text: qsTr("From GPX files, a Parking WP will be put before Main coordinate. You may want to offset the numbering below.")
            ...
            Repeater {
                ...
                ListItem {
                    ...
                    Row {
                        ...
                        TextArea {
                            id: wayptFormula
//                            label: qsTr("Waypoint ") + (number + (Number(offsetValue.text)))
                            label: qsTr("Waypoint ") + (number + (offsetValue.value))
                            text: coord
